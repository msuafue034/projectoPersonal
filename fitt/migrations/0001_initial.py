    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groups', models.ManyToManyField(blank=True, related_name='usuario_set', to='auth.group', verbose_name='Grupos')),
                ('user_permissions', models.ManyToManyField(blank=True, related_name='usuario_set', to='auth.permission', verbose_name='Permisos')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('usuario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='fitt.usuario', verbose_name='Usuario')),
            ],
            options={
